...
type AnnouncesFilters = {
  zipcode?: string;
  categorie_id?: number;
};

class AnnouncesRepository {
  async readAll(filters: AnnouncesFilters = {}) {
    ...
    if (filters.zipcode) {
      ...
      sqlValues.push(filters.zipcode);
    }
  ...
  `;
    ...
    // biome-ignore lint/suspicious/noExplicitAny: Type is inferred from ResultSetHeader
