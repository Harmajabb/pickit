...
// import type { ProfileData, UserPrivate, PublicProfileData, MyProfileData, UserPublic } from "../../types/User";
// import ButtonReport from "../../components/btn-report/ButtonReport";

// function Profile({ mode }: { mode: "me" | "member" }) {
//   const { id } = useParams();
//   const navigate = useNavigate();
//   const { user: authUser, user } = useContext(AuthContext);
...
//         <ButtonReport targetType="user" data={userPublicData} userId={authUser?.id} />
//       </>
//     );
//   }
